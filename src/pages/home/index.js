        ...
        <div className="App">
            <div className="App-header">
                <div className="container left-align">
                    ...
                    <br/>
                    <h5>My focus is on modern JavaScript frameworks and libraries, from 
                      <span className="color3"> React </span> and 
                      <span className="color3"> Vue </span>  
                      on the front-end to 
                      <span className="color3"> node.js </span> and
                      <span className="color3"> Express </span> 
                      on the back-end.
                      </h5>
